...
<template>
  ...
  >
    ...
    <div class="flex basis-1/2 items-center justify-end gap-x-4">
      <!-- Repository -->
      <NuxtLink
        target="_blank"
        to="https://github.com/OyewoleOyedeji/nuxt-phosphor-icons"
      >
      ...
      <!-- Phosphor Icons -->
      <NuxtLink target="_blank" to="https://phosphoricons.com">
        <PhosphorIconPhosphorLogo size="25" />
      </NuxtLink>
